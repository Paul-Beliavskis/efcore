...
{
    public abstract class TPTRelationalQueryTestBase<TFixture> : InheritanceQueryTestBase<TFixture>
        where TFixture : TPTQueryRelationalFixture, new()
    {
        public TPTRelationalQueryTestBase(TFixture fixture)
            : base(fixture)
        {
        }
